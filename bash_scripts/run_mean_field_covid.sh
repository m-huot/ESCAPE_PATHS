...
#SBATCH --array=0-15                 # 16 tasks (4 beta_ab × 4 D values)

# Activate the environment
source activate lantern

# Define parameter arrays
BETA_AB_VALUES=(0 1 3 5)
D_VALUES=(5 10 15 20)
...
folder_name="mean_f_free_ab_beta_ab_${beta_ab}_D_${D}"

# Change to the directory containing the Python script
cd ../mean_field_theory

# Run the Python script
python3 script_mean_field_covid.py --folder ${folder_name} --beta_ab ${beta_ab} --T ${D} --D ${D} 
