...
#SBATCH --array=0-89                  # 3 beta × 1 D × 5 AB configs = 15 tasks
...
# Output folder
folder_name="results_scripts/cocktails_beta/mean_f_free_ab_beta_ab_${beta_ab}_D_${D}_ab_${ab_label}"
